...
class Roombooking:
    def __init__(self,root):
        ...
        # conn = mysql.connector.connect(host="Localhost",username="root",password="Ramasare2129@",database="hotel_management")
        # my_cursor = conn.cursor()
        # my_cursor.execute("Select ROOM_TYPE from details")
        # data_rows = my_cursor.fetchall()

        combo_room_type = ttk.Combobox(lblFrameLeft,textvariable=self.var_room_type,font=("arial",10,"bold"),width=31,state="readonly")
        combo_room_type["value"]=("single","double","luxuary")
        ...
        combo_room_no = ttk.Combobox(lblFrameLeft,textvariable=self.var_room_available,font=("arial",10,"bold"),width=31,state="readonly")
